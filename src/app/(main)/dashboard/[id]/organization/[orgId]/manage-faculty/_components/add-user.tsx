...
import { facultyCreateSchema } from "@/schemas/faculty";
import { useAddFaculty } from "@/hooks/faculty";

type FormInputs = z.infer<typeof facultyCreateSchema>;
...
const AddFacultyModal: React.FC<AddFacultyModalProps> = ({
  ...
  const { mutate: addFacultyMutation, isPending } = useAddFaculty();
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription className="text-sm sm:text-base text-gray-600">
            Fill out the form below to add a new faculty.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex justify-end space-x-3 pt-4">
            ...
            >
              {isPending ? "Adding Faculty..." : "Add Faculty"}
            </Button>
          </div>
        </form>
      </DialogContent>
