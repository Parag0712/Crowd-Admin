...
import { z } from "zod";
import { branchCreateSchema } from "@/schemas/branch";
import { useAddBranch } from "@/hooks/branch";

type FormInputs = z.infer<typeof branchCreateSchema>;
...
const AddBranchModal: React.FC<AddBranchModalProps> = ({
  ...
  const { mutate: addBranchMutation, isPending } = useAddBranch();
  const {
    register,
    handleSubmit,
    reset,
